...
<template>
  <div v-if="subscriptions" class="w-full p-4 flex flex-col gap-10">
    ...
    <div v-else class="text-center text-gray-500">No hay suscripciones pendientes.</div>
  </div>
</template>
