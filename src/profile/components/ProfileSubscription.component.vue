...
<template>
  <div v-if="subscriptionStatus" class="w-full p-4 flex flex-col gap-5 justify-center items-center">
    <h2 class="text-xl md:text-4xl font-bold text-center mb-6">
      Estado de suscripción
    </h2>
    <div v-if="subscriptionStatus === 'No subscription found'" class="flex flex-col gap-4 justify-center items-center">
      <p class="text-center text-2xl">Obtén una suscripción para disfrutar de los beneficios.</p>
      <button v-for="plan in subscriptionPlans" :key="plan.id" class="flex flex-col justify-center items-center px-4 py-20 gap-2 rounded-md shadow-lg hover:shadow-2xl hover:cursor-pointer transition duration-300" @click="goToPurchasePage(plan.id)">
    ...
    <div v-if="subscriptionStatus === 'Pending'" class="flex flex-col gap-4 justify-center items-center">
    ...
    <div v-if="subscriptionStatus === 'Active'" class="flex flex-col gap-4 justify-center items-center">
