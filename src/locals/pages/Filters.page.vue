...
<template>
  ...
  <main class="px-4 sm:px-8 md:px-10 lg:px-16 py-10 w-full min-h-[80dvh] flex flex-col items-center gap-10">
    <div class="w-full flex items-center justify-between">
      <h1 class="text-3xl text-center font-semibold">Aplicar filtros a tu búsqueda:</h1>
    </div>
    <div class="w-[80%] h-full flex flex-col gap-10">
    ...
    <button @click="goToFilterSearch" type="button" class="py-6 bg-(--secondary-color) text-white rounded-md hover:cursor-pointer">
      Aplicar filtros
    </button>
  </div>
  </main>
