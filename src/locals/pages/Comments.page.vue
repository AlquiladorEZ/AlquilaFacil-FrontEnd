...
import { commentsFakeData } from '../../public/data/comments';
...
onMounted(() => {
  ...
  // quiero que los commentsFakeData se conviertan en un array de CommentResponse
  comments.value = commentsFakeData;
  //comments.value = commentsApiService.getAllByLocalId();
})
</script>
