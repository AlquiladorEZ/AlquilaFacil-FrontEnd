...
<template>
  <div class="flex flex-col shadow-lg rounded-lg hover:shadow-xl transition duration-300 ease-in-out hover:cursor-pointer" @click="goToLocal" >
    ...
    <div class="p-4 rounded-lg flex justify-between items-center">
      ...
      <button class="bg-[var(--button-color)] rounded-full size-14 flex justify-center items-center hover:cursor-pointer" >
