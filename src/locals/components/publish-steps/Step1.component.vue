...
<template>
  ...
  <div class="flex flex-col gap-6 max-w-90">
    <div class="flex gap-4 items-center justify-start">
      <img
        src="https://i.ibb.co/2hzsgKf/images-removebg-preview.png"
        alt="Paso 1"
        class="size-24"
      />
      <div class="w-full flex flex-col justify-center">
        <h2 class="text-2xl text-center">1. Describe tu espacio</h2>
        <p class="text-center text-gray-700">Comparte algunos datos básicos</p>
      </div>
    </div>
    <div class="flex gap-4 items-center justify-start">
      <img
        src="https://i.ibb.co/2dWkZMR/images-removebg-preview-1.png"
        alt="Paso 2"
        class="size-24"
      />
      <div class="w-full flex flex-col justify-center">
        <h2 class="text-2xl text-center">2. Haz que destaque</h2>
        <p class="text-center text-gray-700">Agrega una foto y un título a tu espacio, nosotros nos encargamos del resto</p>
      </div>
    </div>
    <div class="flex gap-4 items-center justify-start">
      <img
        src="https://i.ibb.co/xLPKTg9/images-removebg-preview-2.png"
        alt="Paso 3"
        class="size-24"
      />
      <div class="w-full flex flex-col justify-center">
        <h2 class="text-2xl text-center">3. Terminar y publicar</h2>
        <p class="text-center text-gray-700">Agrega las últimas configuraciones y publica tu espacio</p>
      </div>
    </div>
  </div>
</template>